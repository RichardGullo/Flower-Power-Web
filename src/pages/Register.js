      ...
      <div class="column-section">
        ...
        <h1 style={{textAlign:'center'}}>Welcome to <br /> Flower Power!</h1>
          ...
          <form>
            ...
            <input class="textInput" type="text" placeholder="Email Address" onChange={(e)=>setEmail(e.target.value)}/> <br />
            <input class="textInput" type="password" placeholder="Password" onChange={(e)=>setPassword(e.target.value)} /> <br />
            <input class="textInput" type="password" placeholder="Confirm Pasword" onChange={(e)=>setConfirmPassword(e.target.value)} />
            
            <button class="action-button" onClick={doRegister}>SIGN UP</button>
          </form>
          <div>
            <p>Already have an account? <Link class="hyperlink" to="/">Log in here.</Link></p>
          </div>
          <div>
